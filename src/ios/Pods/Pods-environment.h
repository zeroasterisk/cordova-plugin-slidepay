...
// SlidePay_iOS
#define COCOAPODS_POD_AVAILABLE_SlidePay_iOS
#define COCOAPODS_VERSION_MAJOR_SlidePay_iOS 0
#define COCOAPODS_VERSION_MINOR_SlidePay_iOS 0
#define COCOAPODS_VERSION_PATCH_SlidePay_iOS 1
